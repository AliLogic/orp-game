...
AddEvent("OnPlayerJoin", function(playerid)
	...
	SetPlayerPropertyValue(playerid, "shirt_color_r", 255, true)
	SetPlayerPropertyValue(playerid, "shirt_color_g", 255, true)
	SetPlayerPropertyValue(playerid, "shirt_color_b", 255, true)
	SetPlayerPropertyValue(playerid, "shirt_color_a", 255, true)
